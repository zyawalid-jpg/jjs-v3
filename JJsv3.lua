...
═══════════════════════════════════════════════════════════════════
  ...
  Jujutsu Shenanigans | Anti-Cheat Bypass + Gojo 0.2 Auto Kill All
═══════════════════════════════════════════════════════════════════

INSTRUCTIONS :
1. Copie le loadstring ci-dessous
2. Colle dans Delta Executor
3. Execute AVANT de choisir Gojo
4. Selectionne Honored One (Gojo)
5. Active "Gojo God Mode" dans l'onglet Gojo

═══════════════════════════════════════════════════════════════════
LOADSTRING :
═══════════════════════════════════════════════════════════════════

loadstring(game:HttpGet("https://raw.githubusercontent.com/nyxhub/jjs-v3/main/jjsv3.lua"))()

═══════════════════════════════════════════════════════════════════
OU COPIE LE SCRIPT COMPLET CI-DESSOUS :
═══════════════════════════════════════════════════════════════════
